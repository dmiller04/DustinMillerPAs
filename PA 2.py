...
class Register:
    ...
    def display(self, time, reg_name):
        #idle = round(self.idle_time/60,2)
        ...
        print(f'Idle Time = {self.idle_time} seconds')
...
def newCustomerArrives():
    avgArrivalTime = 30  # seconds
    return (random.randrange(avgArrivalTime) == 0) #1 in 30 chance of generating new arrival each second
...
def tabulate_final(register_one,register_two,register_three,register_four,register_express):
    headers = ["Register", "Total Customers", "Total Items", "Total Idle Time (Minutes)", "Avg. Waiting Time"]
    data = [['One', register_one.customers_served,register_one.items_checked_out,register_one.idle_time,register_one.waiting_time],
            ['Two', register_two.customers_served,register_two.items_checked_out,register_two.idle_time,register_two.waiting_time],
            ['Three', register_three.customers_served,register_three.items_checked_out,register_three.idle_time,register_three.waiting_time],
            ['Four', register_four.customers_served,register_four.items_checked_out,register_four.idle_time,register_four.waiting_time],
            ['Express', register_express.customers_served,register_express.items_checked_out,register_express.idle_time,register_express.waiting_time]]
